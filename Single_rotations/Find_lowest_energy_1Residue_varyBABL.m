...
%   rest_of_pro: Cell array of the rest of the protein
...
for chi1 = 1:72
        ...
        for chi2 = 1:max_Chi2
                ...
                for chi3 = 1:72
                    ...
                    if DOF == 3 && total_energy <= min_energy
                        if CH3 == 1
                            ...
                            min_energy_CH3  = rotate_CH3_group_1_find_lowest(Position, HG1_Clash, protein_clash_HG1, rest_pro_position, subtract_array_HG1, delta_term_HG1, HG_Array_1, moveAtomID_HG1);
            ...
            if DOF == 2 && total_energy <= min_energy
                ...
                elseif CH3 == 2
                    ...
                    min_energy_CH3 = rotate_CH3_group_2_find_lowest(Position, HG1_Clash, protein_clash_HG1, HG2_Clash, protein_clash_HG2, rest_pro_position, subtract_array_HG1, delta_term_HG1, HG_Array_1, moveAtomID_HG1, HG_Array_2, moveAtomID_HG2, numAtom,delta_term_HG2,min_energy, total_energy);
    ...
    if DOF == 1 && chi1_energy <= min_energy
        ...
        elseif OH == 0 && DOF == 1 && CH3 == 2
            ...
            min_energy_CH3 = rotate_CH3_group_2_find_lowest(Position, HG1_Clash, protein_clash_HG1, HG2_Clash, protein_clash_HG2, rest_pro_position, subtract_array_HG1, delta_term_HG1, HG_Array_1, moveAtomID_HG1, HG_Array_2, moveAtomID_HG2, numAtom,delta_term_HG2,min_energy, chi1_energy);
        ...
        elseif DOF == 1 && OH == 1 && CH3 == 0
            ...
            min_energy_OH  = rotate_CH3_group_1_find_lowest(Position, OH_Clash, protein_clash_OH, rest_pro_position, subtract_array_OH, delta_term_OH, iOHArray, moveAtomOH);
            ...
            while min_OH_HG1 > 0 && HG1_val < 72
                ...
                if HG1_energy <= min_OH_HG1
                    ...
                    while min_OH>0 && OH_val < 72
                        ...
                        [temp_energy] = get_energy_wProtein(OH_Clash, Position,  protein_clash_OH, rest_pro_position);
